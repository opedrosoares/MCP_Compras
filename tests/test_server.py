...
async def test_ssot_descriptions_pydantic_iguais_a_mcp_schema() -> None:
    ...
    pairs: list[tuple[str, type, list[str]]] = [
        ...
        # --- módulo 07 Contratações (antes sem nenhuma cobertura SSoT) ---
        (
        ...
        (
            ...
            ConsultarContratacao14133Input,
            ["id_contratacao", "tipo_identificador"],
        ),
        (
        ...
        (
            ...
            ListarPdmMaterialInput,
            ["codigo_grupo", "codigo_classe", "codigo_pdm", "apenas_ativos"],
        ),
        (
